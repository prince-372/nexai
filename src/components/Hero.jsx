...
function Hero() {
  return (
    <div className="lg:px-12 px-5 relative z-[1] min-h-screen overflow-x-clip">
      <div className="sm:pt-[13px] pt-0 bg-bg-hero flex bg-center flex-col max-lg:bg-cover lg:bg-BgSize object-cover bg-no-repeat min-h-[95vh] z-10 mt-4">
        <Mynav />
      ...
      <img src={layer} alt="layer" className="absolute  bottom-[-1%] w-full " />
